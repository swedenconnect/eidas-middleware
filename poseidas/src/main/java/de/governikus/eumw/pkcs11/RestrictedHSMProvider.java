...
/**
 * Provides a Restricted HSM bean component for a HSM that is restricted to providing a SAML signing key.
 */
@Slf4j
public class RestrictedHSMProvider
{
  ...
  public RestrictedHSMProvider(@Value("${sc-hsm.p11-config-file:#{null}}") String p11ConfigFile,
  ...
  private void initHSMKey(final String pkcs11ConfigFilePath, String password, String alias) throws Exception
  {
